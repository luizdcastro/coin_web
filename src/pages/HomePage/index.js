        ...
        <div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', height: "80vh" }}>
                <div>
                    ...
                    <h2 style={{ textAlign: 'center', color: "rgba(255,255,255,0.7)", fontSize: 20, marginTop: 15, fontWeight: 300 }}>Create your custom crypto trading bot without coding skills.</h2>
