...
const InputRange = ({ inputLabel, value, ...otherProps }) => {
    ...
    return (
        <div className="custom-input_container">
            ...
            <div className="input-range_contaoner">
                <input type="range" min="0" max="100" step="0.5" value={value || 0} className="slider" style={{ background: background }} {...otherProps} />
